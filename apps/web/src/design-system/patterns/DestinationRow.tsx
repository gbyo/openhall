...
export interface DestinationRowProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  name: string;
  description?: string;
  leading?: ReactNode;
}

export function DestinationRow({ name, description, leading, ...props }: DestinationRowProps) {
  return (

...
INSERT INTO room_category (id,tenant_id,organization_id,name,icon_key,tone_key,student_surface,picker_mode,sort_order) VALUES
('10000000-0000-4000-8000-000000000451','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','Nurse','medical','rose','primary','list',20),
('10000000-0000-4000-8000-000000000452','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','Restroom','restroom','aqua','primary','list',10),
('10000000-0000-4000-8000-000000000453','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','Counselor','chat','violet','primary','list',30),
('10000000-0000-4000-8000-000000000454','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','Library','book','amber','primary','list',40);
INSERT INTO room (id,tenant_id,organization_id,category_id,name,code,floor_label,student_self_requestable,origin_selectable,capacity,queue_enabled,check_in_mode,default_duration_seconds,max_duration_seconds,status) VALUES
('10000000-0000-4000-8000-000000000401','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002',NULL,'Science Lab 214','214','2',false,true,NULL,false,'none',NULL,NULL,'open'),
('10000000-0000-4000-8000-000000000402','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000451','Health Office','NURSE','1',true,true,2,true,'required',900,1800,'open'),
('10000000-0000-4000-8000-000000000403','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000452','Second Floor Restroom','R2','2',true,false,3,true,'none',420,900,'open'),
('10000000-0000-4000-8000-000000000404','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000453','Counseling Center','COUNSEL','1',true,false,2,true,'optional',1200,2400,'open'),
('10000000-0000-4000-8000-000000000405','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000454','Library Media Center','LIB','1',true,false,12,false,'optional',1200,3600,'open');
...
INSERT INTO authorization_grant (id,tenant_id,account_id,role,scope_kind,room_id,created_by_account_id) VALUES ('10000000-0000-4000-8000-000000000602','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000102','room_staff','room','10000000-0000-4000-8000-000000000402','10000000-0000-4000-8000-000000000101');
...
INSERT INTO section_meeting (id,tenant_id,section_id,schedule_block_id,room_id,organization_id) VALUES ('10000000-0000-4000-8000-000000000704','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000303','10000000-0000-4000-8000-000000000701','10000000-0000-4000-8000-000000000401','10000000-0000-4000-8000-000000000002');
...
INSERT INTO scheduled_authorization (id,tenant_id,organization_id,student_id,destination_room_id,created_by_person_id,created_by_account_id,valid_from,valid_until,approval_mode,origin_strategy,display_category) VALUES
('10000000-0000-4000-8000-000000000901','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000203','10000000-0000-4000-8000-000000000404','10000000-0000-4000-8000-000000000201','10000000-0000-4000-8000-000000000101',now()-interval '30 minutes',now()+interval '2 hours','preapproved','expected','Counselor appointment'),
('10000000-0000-4000-8000-000000000902','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000205','10000000-0000-4000-8000-000000000402','10000000-0000-4000-8000-000000000201','10000000-0000-4000-8000-000000000101',now()+interval '1 day',now()+interval '1 day 2 hours','approval_required','expected','Medication');

INSERT INTO pass (id,tenant_id,organization_id,student_id,origin_room_id,origin_section_id,destination_room_id,return_room_id,request_source,requested_by_person_id,requested_at,lifecycle_state,expected_return_at,revision,departure_check_in_mode,departure_destination_revision) VALUES
('10000000-0000-4000-8000-000000001001','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000204','10000000-0000-4000-8000-000000000401','10000000-0000-4000-8000-000000000303','10000000-0000-4000-8000-000000000403','10000000-0000-4000-8000-000000000401','student_web','10000000-0000-4000-8000-000000000204',now()-interval '3 minutes','requested',now()+interval '10 minutes',1,NULL,NULL),
('10000000-0000-4000-8000-000000001002','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000205','10000000-0000-4000-8000-000000000401','10000000-0000-4000-8000-000000000303','10000000-0000-4000-8000-000000000402','10000000-0000-4000-8000-000000000401','staff_web','10000000-0000-4000-8000-000000000202',now()-interval '7 minutes','outbound',now()+interval '18 minutes',3,'required',1),
('10000000-0000-4000-8000-000000001003','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000206','10000000-0000-4000-8000-000000000401','10000000-0000-4000-8000-000000000303','10000000-0000-4000-8000-000000000404','10000000-0000-4000-8000-000000000401','student_web','10000000-0000-4000-8000-000000000206',now()-interval '5 minutes','queued',now()+interval '25 minutes',2,NULL,NULL),
('10000000-0000-4000-8000-000000001004','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000207','10000000-0000-4000-8000-000000000401','10000000-0000-4000-8000-000000000303','10000000-0000-4000-8000-000000000405','10000000-0000-4000-8000-000000000401','student_web','10000000-0000-4000-8000-000000000207',now()-interval '2 days','completed',now()-interval '2 days 40 minutes',5,'optional',1);
...
INSERT INTO pass_approval (id,tenant_id,organization_id,pass_id,origin_evaluation_result_id,policy_rule_id,policy_rule_revision,approver_kind,required_section_id) VALUES
('10000000-0000-4000-8000-000000001121','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000001001','10000000-0000-4000-8000-000000001111','10000000-0000-4000-8000-000000000802',1,'current_section_teacher','10000000-0000-4000-8000-000000000303');
INSERT INTO room_reservation (id,tenant_id,room_id,pass_id,reserved_at,ready_expires_at,organization_id,policy_evaluation_id,claimed_at,flow_expires_at) VALUES
('10000000-0000-4000-8000-000000001131','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000402','10000000-0000-4000-8000-000000001002',now()-interval '6 minutes',now()-interval '4 minutes','10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000001102',now()-interval '5 minutes',now()+interval '20 minutes');
INSERT INTO queue_entry (id,tenant_id,room_id,pass_id,entered_at,priority,organization_id,policy_evaluation_id,flow_expires_at) VALUES
('10000000-0000-4000-8000-000000001141','10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000404','10000000-0000-4000-8000-000000001003',now()-interval '4 minutes',0,'10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000001103',now()+interval '25 minutes');
...
('10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','account','10000000-0000-4000-8000-000000000101','room.updated','room','10000000-0000-4000-8000-000000000402','success',now()-interval '1 day','demo-audit-1','{"field":"capacity"}'),
